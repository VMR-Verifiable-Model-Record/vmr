// Terminal column widths, generated from Unicode 15.0.0 (the unicodedata
// module of Python 3.12.10): WIDE is East_Asian_Width W or F; ZERO is
// General_Category Mn or Me, and U+1160..U+11FF. Do not edit by hand:
// regenerate from the same Unicode data and review the change like a
// vector's (QA QP-05).

/// Code points a terminal draws in no column: General_Category Mn or Me, and U+1160..U+11FF.
pub const ZERO: &[(u32, u32)] = &[
    ...
    (0x01082, 0x01082), (0x01085, 0x01086), (0x0108d, 0x0108d), (0x0109d, 0x0109d), (0x01160, 0x011ff),
    (0x0135d, 0x0135f), (0x01712, 0x01714), (0x01732, 0x01733), (0x01752, 0x01753), (0x01772, 0x01773),
    (0x017b4, 0x017b5), (0x017b7, 0x017bd), (0x017c6, 0x017c6), (0x017c9, 0x017d3), (0x017dd, 0x017dd),
    (0x0180b, 0x0180d), (0x0180f, 0x0180f), (0x01885, 0x01886), (0x018a9, 0x018a9), (0x01920, 0x01922),
    (0x01927, 0x01928), (0x01932, 0x01932), (0x01939, 0x0193b), (0x01a17, 0x01a18), (0x01a1b, 0x01a1b),
    (0x01a56, 0x01a56), (0x01a58, 0x01a5e), (0x01a60, 0x01a60), (0x01a62, 0x01a62), (0x01a65, 0x01a6c),
    (0x01a73, 0x01a7c), (0x01a7f, 0x01a7f), (0x01ab0, 0x01ace), (0x01b00, 0x01b03), (0x01b34, 0x01b34),
    (0x01b36, 0x01b3a), (0x01b3c, 0x01b3c), (0x01b42, 0x01b42), (0x01b6b, 0x01b73), (0x01b80, 0x01b81),
    (0x01ba2, 0x01ba5), (0x01ba8, 0x01ba9), (0x01bab, 0x01bad), (0x01be6, 0x01be6), (0x01be8, 0x01be9),
    (0x01bed, 0x01bed), (0x01bef, 0x01bf1), (0x01c2c, 0x01c33), (0x01c36, 0x01c37), (0x01cd0, 0x01cd2),
    (0x01cd4, 0x01ce0), (0x01ce2, 0x01ce8), (0x01ced, 0x01ced), (0x01cf4, 0x01cf4), (0x01cf8, 0x01cf9),
    (0x01dc0, 0x01dff), (0x020d0, 0x020f0), (0x02cef, 0x02cf1), (0x02d7f, 0x02d7f), (0x02de0, 0x02dff),
    (0x0302a, 0x0302d), (0x03099, 0x0309a), (0x0a66f, 0x0a672), (0x0a674, 0x0a67d), (0x0a69e, 0x0a69f),
    (0x0a6f0, 0x0a6f1), (0x0a802, 0x0a802), (0x0a806, 0x0a806), (0x0a80b, 0x0a80b), (0x0a825, 0x0a826),
    (0x0a82c, 0x0a82c), (0x0a8c4, 0x0a8c5), (0x0a8e0, 0x0a8f1), (0x0a8ff, 0x0a8ff), (0x0a926, 0x0a92d),
    (0x0a947, 0x0a951), (0x0a980, 0x0a982), (0x0a9b3, 0x0a9b3), (0x0a9b6, 0x0a9b9), (0x0a9bc, 0x0a9bd),
    (0x0a9e5, 0x0a9e5), (0x0aa29, 0x0aa2e), (0x0aa31, 0x0aa32), (0x0aa35, 0x0aa36), (0x0aa43, 0x0aa43),
    (0x0aa4c, 0x0aa4c), (0x0aa7c, 0x0aa7c), (0x0aab0, 0x0aab0), (0x0aab2, 0x0aab4), (0x0aab7, 0x0aab8),
    (0x0aabe, 0x0aabf), (0x0aac1, 0x0aac1), (0x0aaec, 0x0aaed), (0x0aaf6, 0x0aaf6), (0x0abe5, 0x0abe5),
    (0x0abe8, 0x0abe8), (0x0abed, 0x0abed), (0x0fb1e, 0x0fb1e), (0x0fe00, 0x0fe0f), (0x0fe20, 0x0fe2f),
    ...
    (0x13440, 0x13440), (0x13447, 0x13455), (0x16af0, 0x16af4), (0x16b30, 0x16b36), (0x16f4f, 0x16f4f),
    (0x16f8f, 0x16f92), (0x16fe4, 0x16fe4), (0x1bc9d, 0x1bc9e), (0x1cf00, 0x1cf2d), (0x1cf30, 0x1cf46),
    ...
    (0x1e026, 0x1e02a), (0x1e08f, 0x1e08f), (0x1e130, 0x1e136), (0x1e2ae, 0x1e2ae), (0x1e2ec, 0x1e2ef),
    (0x1e4ec, 0x1e4ef), (0x1e8d0, 0x1e8d6), (0x1e944, 0x1e94a), (0xe0100, 0xe01ef),
];

/// Code points a terminal draws two columns wide: East_Asian_Width W or F.
